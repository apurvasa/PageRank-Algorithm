...
// 
 ...
 public class SpeciesIterMapper2 extends MapReduceBase implements Mapper<WritableComparable, Writable, Text, Text> { 
   ...
   public void map(WritableComparable key, Writable value, 
     ...
     int colon = pagetitle.indexOf(":");//remove de and all
     pagetitle = pagetitle.substring(colon+1);
     String pagerank = splits[splits.length - 1].trim();
 //    System.out.println("pagerank:"+pagerank+"element: "+splits[splits.length - 1] );
     ...
     for (String page : pages) { 
       if(page.length() > 0) {
//    	   if (pagetitle.equals("Acanthodii")){
//    	      System.out.println(page+" no: "+toEmit);
...
//     if (pagetitle.equals("Acanthodii")){
//	      System.out.println(pagetitle+" .02 ");
//	      System.out.println(pagetitle+" title: "+data);
//	      
//	   }
     double n = 0.02 * (1.0 * numoutlinks);
     output.collect(new Text(pagetitle), new Text(String.valueOf(n))); 
